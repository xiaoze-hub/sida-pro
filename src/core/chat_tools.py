...
WENCAI_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    # --- 决策先锋三指标共振 (官方 8问8答 §3.4/§5/§6 口径; 与桌面 5_GZZH.txt 差异见 note) ---
    "三指标买共振":   {"q": "GS策略出现G信号, AI机构活跃度大于3, 主力暗盘资金净流入, 非ST", "src": "wencai_nlp",
                       "note": "官方首次共振(向好)§3.4 row1: G信号+强势线上(>3)+流入; 桌面5_GZZH.txt 用'暗盘红连3日'更严"},
    "三指标卖共振":   {"q": "GS策略出现S信号, 主力暗盘资金净流出, AI机构活跃度小于3, 非ST", "src": "wencai_nlp",
                       "note": "官方全走坏§3.4 row7: S信号+跌破强势线(<3)+流出; 桌面5_GZZH.txt 误用'活跃度较前日下降'(未要求跌破强势线), 已按官方修正"},
    "三指标选股共振": {"q": "主力暗盘资金连续3日净流入, GS策略出现G信号, AI机构活跃度连续3日大于3, 非ST", "src": "wencai_nlp",
                       "note": "官方选股§6: 暗盘持续买+G信号+活跃度连续多日强势线上; 桌面5_GZZH.txt 用'活跃度>6(大牛线)+暗盘单日>0'更严, 已按官方修正"},
}
