...
- **Phase 1 Dashboard去卡片化** (09-03, feat分支). MarketPhaseCard大字盒→左色条+文字(阶段色只留border/text)、Stat小格→hairline左刻线; MarketMainlineCard行盒→border-b分隔; Dashboard分享下拉rounded-lg→md. Dashboard页其余区(资金流/异动/工作台)此前已是hairline, 本次动三处卡片残留. tsc 0 + build 15s.
