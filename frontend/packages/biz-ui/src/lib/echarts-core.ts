...
import { BarChart, GaugeChart, LineChart, CandlestickChart, HeatmapChart, TreemapChart } from 'echarts/charts'
import {
...
// 新图表类型/组件在这里追加注册
echarts.use([
  BarChart, GaugeChart, LineChart, CandlestickChart, HeatmapChart, TreemapChart,
  GridComponent, TooltipComponent, MarkLineComponent,
  LegendComponent, DataZoomComponent, VisualMapComponent, TitleComponent,
  CanvasRenderer,
])
