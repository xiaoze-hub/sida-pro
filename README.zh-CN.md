...
![Version](https://img.shields.io/badge/version-v0.10.46-blue) <!-- 发版时随 VERSION 文件同步更新 -->
...
# 或: docker pull crpi-mte80ai8o78b1429.cn-shanghai.personal.cr.aliyuncs.com/xiaozexwz/xzxwz:$(cat VERSION)  # 版本以仓库 VERSION 文件为准
